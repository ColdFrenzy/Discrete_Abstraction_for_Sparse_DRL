...
agent1 = SAC_HER(name = experiment_name, agent_name="a1",  env = env1, max_episodes = NUM_EPISODES_CONT, alpha_initial=0.4, alpha_final=0.01, gamma=0.1, max_ep_alpha_decay=2000)
