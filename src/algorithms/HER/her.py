...
class her_sampler:
    def __init__(self, replay_strategy, replay_k, reward_func=None):
        ...
        Args:
            replay_strategy (str): Strategy for sampling HER transitions.
                Supported strategies are future
    ...
    def sample_her_transitions(self, episode_batch, batch_size_in_transitions):
        ...
        Args:
            episode_batch (dict): Batch of episodes.
            batch_size_in_transitions (int): Batch size for transitions.
        Returns:
            transitions (dict): Transitions with HER.
        """
        ...
        transitions['reward'] = np.expand_dims(self.reward_func(transitions['ag_next'], transitions['g'], None), 1)
